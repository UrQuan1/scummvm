...
#define GAMEOPTION_SPEEDTHROTTLER             GUIO_GAMEOPTIONS7
	// TODO: properly implement GAMEOPTIONs

#define GAMEOPTIONS_DEFAULT                   GUIO5(GAMEOPTION_SPEEDTHROTTLER,GAMEOPTION_ORIGINAL_SAVELOAD,GAMEOPTION_DISABLE_MOUSE,GAMEOPTION_USE_HERCULES_FONT,GAMEOPTION_COMMAND_PROMPT_WINDOW)
...
#define GAMEOPTIONS_FANMADE_MOUSE             GUIO4(GAMEOPTION_SPEEDTHROTTLER,GAMEOPTION_ORIGINAL_SAVELOAD,GAMEOPTION_USE_HERCULES_FONT,GAMEOPTION_COMMAND_PROMPT_WINDOW)
...
static const AGIGameDescription gameDescriptions[] = {
	...
	GAME_FO("serguei1", "v1.1 2002 Sep 5", "91975c1fb4b13b0f9a8e9ff74731030d", 0x2917, GF_FANMADE|GF_AGIMOUSE, GID_FANMADE, GAMEOPTIONS_FANMADE_MOUSE),	// AGIPAL
	GAME_FO("serguei1", "v1.1 2003 Apr 10", "91975c1fb4b13b0f9a8e9ff74731030d", 0x2917, GF_FANMADE|GF_AGIMOUSE, GID_FANMADE, GAMEOPTIONS_FANMADE_MOUSE),	// AGIPAL
