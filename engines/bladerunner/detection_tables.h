...
#define GAMEOPTION_FRAMELIMITER_FPS           GUIO_GAMEOPTIONS3
#define GAMEOPTION_DISABLE_STAMINA_DRAIN      GUIO_GAMEOPTIONS4
...
static const ADGameDescription gameDescriptions[] = {
	// BladeRunner (English) - ENG
	{
		...
		ADGF_NO_FLAGS,
		GUIO5(GAMEOPTION_SITCOM, GAMEOPTION_SHORTY, GAMEOPTION_FRAMELIMITER_FPS, GAMEOPTION_DISABLE_STAMINA_DRAIN, GUIO_NOMIDI)
	},
